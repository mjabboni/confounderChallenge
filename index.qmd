...
ax.scatter(dreamy_df['severity'], dreamy_df['post_surgical_score'], 
           marker='o', s=100, color='#4E79A7', label='Doc Dreamy', alpha=0.7, edgecolors='black', linewidth=0.5, zorder=3)
ax.scatter(duck_df['severity'], duck_df['post_surgical_score'], 
           marker='^', s=100, color='#E15759', label='Doc Duck', alpha=0.7, edgecolors='black', linewidth=0.5, zorder=3)
