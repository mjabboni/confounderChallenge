...
ax.text(5, mean_dreamy + 0.15, f'○ Doc Dreamy Mean: {mean_dreamy:.2f}', 
        fontsize=11, color='#4E79A7', fontweight='bold', va='bottom',
...
ax.text(5, mean_duck - 0.15, f'△ Doc Duck Mean: {mean_duck:.2f}', 
        fontsize=11, color='#E15759', fontweight='bold', va='top',
...
# Normalize severity values for colormap
...
# Plot scatter points with color gradient based on severity
scatter_dreamy = ax.scatter(dreamy_df['severity'], dreamy_df['post_surgical_score'], 
           marker='o', s=100, c=dreamy_df['severity'], cmap=cmap, norm=norm,
           label='Doc Dreamy', alpha=0.8, edgecolors='black', linewidth=0.5, zorder=3)
scatter_duck = ax.scatter(duck_df['severity'], duck_df['post_surgical_score'], 
           marker='^', s=100, c=duck_df['severity'], cmap=cmap, norm=norm,
...
ax.text(-2.8, mean_dreamy + 0.15, f'○ Doc Dreamy Mean: {mean_dreamy:.2f}', 
        fontsize=11, color='#4E79A7', fontweight='bold', va='bottom',
        bbox=dict(boxstyle='square', facecolor='white', edgecolor='#4E79A7', alpha=0.9, linewidth=2))
ax.text(-2.8, mean_duck - 0.15, f'△ Doc Duck Mean: {mean_duck:.2f}', 
        fontsize=11, color='#E15759', fontweight='bold', va='top',
        bbox=dict(boxstyle='square', facecolor='white', edgecolor='#E15759', alpha=0.9, linewidth=2))
